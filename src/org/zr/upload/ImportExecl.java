...
public class ImportExecl
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		List<List<String>> list = poi.read("C:/Users/DELL/Desktop/格式.xlsx");
...
String a="";
	...
	public static List<String> getAllInfo(String path){
...
//读取信景的excel 返回核销卡卷的code  
//第三列就是卷号  第0行是说明题目
public static List<String> getAllCode(String path){
	List<String> ls=new ArrayList<String>();
	//num+P+password
	ImportExecl poi = new ImportExecl();
