...
/**
 * 历史上的今天查询服务
 * http://api.ajaxsns.com/api.php?key=free&appid=0&msg=%E7%AC%91%E8%AF%9D  笑话
 * @author liufeng
 * @date 2013-10-16
 * 
 */
public class GetHistory {
	...
	public static String getTodayInHistoryInfo() {
		// 获取网页源代码
		String html = FaceService.httpRequest("http://www.rijiben.com");
		// 从网页中抽取信息
		String result = extract(html);
		return result;
	}
	 
		public static String getwushang(String fromUserName,String toUserName ) {
			//创建武商网图文消息
			String picurl="http://img1.wushang.com/img/2014/10/22/2044656.jpg";
			String url="http://baike.baidu.com/link?url=Gpl7S5c_HLjMzykFSaAKTXCTCEyKVzXmY8G1EL9eKujwUoANAIeGKJ3gmbntfxyZ63HJv_TJLWbSm3XMtvh9Ua";
			String title="武商网";
		    String descript="武商网是满足消费者一站式需求的B2C网站。";
			//CreateMessage ce=new CreateMessage();
			String a=CreateMessage.CreateArticleMessage(title, descript, picurl, url, toUserName, fromUserName);
			String result = a;
			return result;
		}
