...
public class UploadCustomServlet extends HttpServlet {
	private static Logger log=LoggerFactory.getLogger(UploadCustomServlet.class);
	                        ...
	                        if(item.isFormField()){
	                           ...
	                           //   CardNumDao cdao=new CardNumDaoImol();
	                              ...
	                              while(ite.hasNext()){
	                            	 ...
	                            	 ChatAction.saveChatInfo(question, answer);
	                              }
